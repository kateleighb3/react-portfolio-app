...
const About = () => {
    return (
        <div id='about' className='w-full md:pl-20 p-4 bg-cover bg-[url("./assets/vaporwave_2.jpg")] py-16'>
            ...
            Hello! I'm Kate and I'm a results-driven IT professional with experience in application design and computer science. I have a strong passion for coding and creating.
            <br/>
            <br/>
            ...
            <br/>
            <br/>
            Right now I am working on building other prosjects, eager to learn and apply new skills and continue on this awesome journey.
            <br/>
            <br/>
